...
<!--					<ul class="my-account-nav">
		...
		<div class="col-md-8">
                <!-- Section heading -->
		            <h2 class="h2-responsive wow fadeIn">Manage Property Features</h2>
		            <hr>
		            <a class="btn btn-unique" data-toggle="modal" data-target="#addFeatures">Add New Feature</a>
		            <hr>
		        <?php
					if(!empty($sessData['userLoggedIn']) && !empty($sessData['userID'])){
						include 'user.php';
						$user = new User();
						$features = $user->getRows("property_features_list");
				?>
			<table id="user-list" class="table table-responsive z-depth-2 user-list" cellspacing="0" width="100%">
				...
				?>
						...
						<td class="align-middle"><?php echo $feature['title']; ?></td>
						<td><a class="btn btn-info" onclick="get_details('<?php echo $feature['feature_id']; ?>')">Edit</a></td>
						<td><a class="btn btn-danger" onclick="delete_feature('<?php echo $feature['feature_id']; ?>')">Delete</a></td></tr>
                 <?php endforeach; else: 
                  endif; 
                  }?>		
			  </tbody>
...
<hr>
        ...
        <div class="modal-dialog modal-notify modal-warning" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <p class="heading lead">Edit Features</p>
   ...
   <!-- Central Modal Medium Success -->
    <div class="modal fade" id="addFeatures" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-notify modal-warning" role="document">
            <!--Content-->
            <div class="modal-content">
                <!--Header-->
                <div class="modal-header">
                    <p class="heading lead">Add New Features</p>
