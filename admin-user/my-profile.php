...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo $linkpath; ?>/assets/css/font-awesome.min.css">
    <!-- Bootstrap core CSS -->
    <link href="<?php echo $linkpath; ?>/assets/css/bootstrap.min.css" rel="stylesheet">
    <!-- Material Design Bootstrap -->
    <link href="<?php echo $linkpath; ?>/assets/css/mdb.min.css" rel="stylesheet">
    <!-- Your custom styles (optional) -->
    <link href="<?php echo $linkpath; ?>/assets/css/style.css" rel="stylesheet">
</head>
                    ...
                    <div class="col-md-12 mb-r">
                        ...
                        <div class="col-md-4 float-left">
                            <div class="avatar edit-profile-photo">
								...
								<img src="http://rs.solorix.com/assets/images/agents/<?php echo $userProfile['image']; ?>" class="z-depth-1" id="imgholder" width="590" alt="">
								<?php } else {  ?>
								<img src="http://rs.solorix.com/assets/images/agents/default_avatar.jpg" class="z-depth-1" id="imgholder" alt="">
								<?php } ?>
...
================================================== -->
    <!-- JQuery -->
    <script type="text/javascript" src="<?php echo $linkpath; ?>/assets/js/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap tooltips -->
    <script type="text/javascript" src="<?php echo $linkpath; ?>/assets/js/popper.min.js"></script>
    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="<?php echo $linkpath; ?>/assets/js/bootstrap.min.js"></script>
    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="<?php echo $linkpath; ?>/assets/js/mdb.min.js"></script>
