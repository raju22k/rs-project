                    ...
                    <div class="row wow fadeIn" data-wow-delay="0.4s">
                        <div class="col-lg-12">
                            <div class="divider-new">
                                <h2 class="h2-responsive">Fully Furnished Flats for rent in Chennai</h2>
                            </div>
                        </div>
                    </div>
                    <!--/.First row-->
...
<?php
            ...
            $conditions['where']['property_status'] = 'RENT'; // RENT
            $conditions['where']['type_id'] = '3'; // Fully furnished flats for RENT
